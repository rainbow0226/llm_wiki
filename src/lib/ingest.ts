...
export function buildGenerationPrompt(
  ...
  return [
    ...
    "",
    "Optional typed-edge fields (bare slugs, same array form as `related`; include ONLY when the",
    "relationship genuinely holds — they become directed edges in the knowledge graph):",
    "  • prerequisites      — pages a reader should understand FIRST (`prerequisites: [oauth-basics]`).",
    "  • supersedes         — page(s) this one replaces/obsoletes (decisions, policies).",
    "  • related_decisions  — decision pages relevant to this one.",
    "",
